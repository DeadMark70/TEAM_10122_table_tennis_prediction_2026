...
ACTION_SCRIPT = PROJECT_ROOT / "analysis_v173_external_curriculum_pretrain.py"


def main() -> None:
    parser = add_common_args(
        argparse.ArgumentParser(description="Train/build the V173 external-curriculum action teacher.")
    )
    ...
    run_python(ACTION_SCRIPT, cwd=ROOT, dry_run=args.dry_run)
