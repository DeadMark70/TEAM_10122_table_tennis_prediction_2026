...
SERVER_SCRIPT = PROJECT_ROOT / "analysis_v300_clean_server_blend_recycler.py"


def main() -> None:
    parser = add_common_args(
        argparse.ArgumentParser(description="Train/build the V300 clean conservative server blend.")
    )
    ...
    run_python(SERVER_SCRIPT, cwd=ROOT, dry_run=args.dry_run)
