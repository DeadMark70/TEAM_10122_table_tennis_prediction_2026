...
def main() -> None:
    ...
    report = {
        ...
        "fold_ensemble_raw_diagnostic": foldens_info,
        ...
        "notes": [
            ...
            "If both raw exports collapse to all pointId=0, do not upload raw before residual probes.",
    ...
    (OUTDIR / "v188_raw_gru_diagnostic_report.md").write_text(
        ...
        f"- Fold-ensemble raw submission: `{foldens_info['upload_path']}`\n"
